  ...
  return (
    <div className="min-h-screen bg-porcelain">
      <div className="max-w-7xl mx-auto px-5 md:px-8 py-12 md:py-16">
        <div className="mb-10">
          <p className="text-sage text-sm font-semibold tracking-widest uppercase mb-2">My Account</p>
          <h1 className="font-display text-3xl md:text-4xl text-ink">
            Welcome back{userName ? `, ${userName.split(" ")[0]}` : ""}
          </h1>
          <p className="text-ink/50 mt-2">
            Manage your pets, track their medications, and review your orders.
          </p>
        </div>

        <div className="grid grid-cols-3 gap-4 mb-10">
          <StatCard label="Pets" value={pets.length} icon={PawPrint} />
          <StatCard label="Medications Tracked" value={totalMeds} icon={FileText} />
  ...
  return (
    <div className="cellular-card py-16 flex flex-col items-center text-center">
      <div className="w-16 h-16 rounded-full bg-sage/10 flex items-center justify-center mb-4">
        <Icon className="w-7 h-7 text-sage/50" />
      </div>
