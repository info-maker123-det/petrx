...
export default function SupplementsCatalog({ products, loading, linkParams = "", mobileScroll = false }) {
  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto px-5 md:px-8 py-10 md:py-20">
        ...
        {/* AutoShip strip */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-8 md:mb-12 bg-white rounded-3xl border-[0.5px] border-border px-6 py-5">
        ...
        <CatalogGrid products={products} loading={loading} columns={3} emptyText="No supplements available right now." mobileScroll={mobileScroll} />
      </div>
    </div>
  );
}